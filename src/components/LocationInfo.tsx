    ...
    <section className="py-16 overflow-hidden animate-fade-in" style={{ animationDelay: '0.3s' }}>
      ...
      {climate && (
        <div className="container mx-auto">
          <h3 className="text-2xl font-light text-white frosted-text mb-6 text-center animate-slide-up" style={{ animationDelay: '0.8s' }}>
            Climate Overview
          </h3>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            <div className="frost-panel p-6 rounded-2xl animate-slide-up" style={{ animationDelay: '0.9s' }}>
              <div className="flex items-center mb-4">
                <ThermometerSun size={22} className="text-amber-400 mr-3" />
                <h4 className="text-lg text-white">Temperature</h4>
              </div>
              <p className="text-3xl text-white font-light mb-2">{climate.averageTemp}°C</p>
              <p className="text-white/70 text-sm">Annual average temperature</p>
            </div>
            
            <div className="frost-panel p-6 rounded-2xl animate-slide-up" style={{ animationDelay: '1s' }}>
              <div className="flex items-center mb-4">
                <Umbrella size={22} className="text-blue-400 mr-3" />
                <h4 className="text-lg text-white">Precipitation</h4>
              </div>
              <p className="text-3xl text-white font-light mb-2">{climate.annualRainfall} mm</p>
              <p className="text-white/70 text-sm">Annual rainfall</p>
            </div>
            
            <div className="frost-panel p-6 rounded-2xl animate-slide-up" style={{ animationDelay: '1.1s' }}>
              <div className="flex items-center mb-4">
                <Calendar size={22} className="text-green-400 mr-3" />
                <h4 className="text-lg text-white">Seasons</h4>
              </div>
          ...
          <div className="frost-panel p-6 rounded-2xl mb-10 animate-slide-up" style={{ animationDelay: '1.2s' }}>
            <h4 className="text-xl text-white mb-4">Climate Description</h4>
            <p className="text-white/80 leading-relaxed">{climate.description}</p>
          </div>
